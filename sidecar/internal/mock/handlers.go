...
func (h *SidecarHandler) Heartbeat(ctx context.Context, req *flowv1.HeartbeatRequest) (*flowv1.HeartbeatResponse, error) {
...
func (h *OperatorHandler) SubmitResult(ctx context.Context, req *flowv1.SubmitResultRequest) (*flowv1.SubmitResultResponse, error) {
	workitemID := req.GetWorkitemId()
	if workitemID == "" {
		workitemID = extractWorkitemID(ctx)
	}
...
func (h *OperatorHandler) CreateWorkitem(ctx context.Context, req *flowv1.CreateWorkitemRequest) (*flowv1.CreateWorkitemResponse, error) {
	slog.Info("Sidecar intercepted CreateWorkitem (mock)")
	return &flowv1.CreateWorkitemResponse{WorkitemId: "mock-workitem-001"}, nil
}

func (h *OperatorHandler) CreateHearingWorkitem(ctx context.Context, req *flowv1.CreateHearingWorkitemRequest) (*flowv1.CreateHearingWorkitemResponse, error) {
...
func (h *OperatorHandler) ExportWorkitem(ctx context.Context, req *flowv1.ExportWorkitemRequest) (*flowv1.ExportWorkitemResponse, error) {
...
func (h *OperatorHandler) ImportWorkitem(ctx context.Context, req *flowv1.ImportWorkitemRequest) (*flowv1.ImportWorkitemResponse, error) {
...
func (h *ArchivistHandler) GetArtefact(ctx context.Context, req *flowv1.GetArtefactRequest) (*flowv1.GetArtefactResponse, error) {
...
func (h *ArchivistHandler) ListArtefacts(ctx context.Context, req *flowv1.ListArtefactsRequest) (*flowv1.ListArtefactsResponse, error) {
	slog.Info("Sidecar intercepted ListArtefacts (mock)", "workitem_id", req.GetWorkitemId())
	return &flowv1.ListArtefactsResponse{}, nil
}

func (h *ArchivistHandler) StoreArtefact(ctx context.Context, req *flowv1.StoreArtefactRequest) (*flowv1.StoreArtefactResponse, error) {
