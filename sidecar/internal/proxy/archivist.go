...
func (p *ArchivistProxy) StoreArtefact(ctx context.Context, req *flowv1.StoreArtefactRequest) (*flowv1.StoreArtefactResponse, error) {
...
func (p *ArchivistProxy) GetArtefact(ctx context.Context, req *flowv1.GetArtefactRequest) (*flowv1.GetArtefactResponse, error) {
	outCtx := propagateMetadata(ctx)
...
func (p *ArchivistProxy) GetArtefactVersion(ctx context.Context, req *flowv1.GetArtefactVersionRequest) (*flowv1.GetArtefactVersionResponse, error) {
	outCtx := propagateMetadata(ctx)
	return p.client.GetArtefactVersion(outCtx, req)
}

// GetArtefactMetadata forwards to the Archivist (passthrough).
func (p *ArchivistProxy) GetArtefactMetadata(ctx context.Context, req *flowv1.GetArtefactMetadataRequest) (*flowv1.GetArtefactMetadataResponse, error) {
	outCtx := propagateMetadata(ctx)
	return p.client.GetArtefactMetadata(outCtx, req)
}

// ListArtefacts forwards to the Archivist (passthrough).
func (p *ArchivistProxy) ListArtefacts(ctx context.Context, req *flowv1.ListArtefactsRequest) (*flowv1.ListArtefactsResponse, error) {
	outCtx := propagateMetadata(ctx)
	return p.client.ListArtefacts(outCtx, req)
}

// QueryArtefactState forwards to the Archivist (passthrough).
func (p *ArchivistProxy) QueryArtefactState(ctx context.Context, req *flowv1.QueryArtefactStateRequest) (*flowv1.QueryArtefactStateResponse, error) {
	outCtx := propagateMetadata(ctx)
...
func (p *ArchivistProxy) GetStamps(ctx context.Context, req *flowv1.GetStampsRequest) (*flowv1.GetStampsResponse, error) {
...
func (p *ArchivistProxy) StampArtefact(ctx context.Context, req *flowv1.StampArtefactRequest) (*flowv1.StampArtefactResponse, error) {
	return p.client.StampArtefact(propagateMetadata(ctx), req)
}

// --- Feedback passthroughs ---

func (p *ArchivistProxy) AddFeedback(ctx context.Context, req *flowv1.AddFeedbackRequest) (*flowv1.AddFeedbackResponse, error) {
	return p.client.AddFeedback(propagateMetadata(ctx), req)
}

func (p *ArchivistProxy) GetFeedback(ctx context.Context, req *flowv1.GetFeedbackRequest) (*flowv1.GetFeedbackResponse, error) {
	return p.client.GetFeedback(propagateMetadata(ctx), req)
}

func (p *ArchivistProxy) HasUnresolvedFeedback(ctx context.Context, req *flowv1.HasUnresolvedFeedbackRequest) (*flowv1.HasUnresolvedFeedbackResponse, error) {
	return p.client.HasUnresolvedFeedback(propagateMetadata(ctx), req)
}

func (p *ArchivistProxy) ResolveFeedback(ctx context.Context, req *flowv1.ResolveFeedbackRequest) (*flowv1.ResolveFeedbackResponse, error) {
	return p.client.ResolveFeedback(propagateMetadata(ctx), req)
}

func (p *ArchivistProxy) RefuseFeedback(ctx context.Context, req *flowv1.RefuseFeedbackRequest) (*flowv1.RefuseFeedbackResponse, error) {
	return p.client.RefuseFeedback(propagateMetadata(ctx), req)
}

func (p *ArchivistProxy) AcceptFix(ctx context.Context, req *flowv1.AcceptFixRequest) (*flowv1.AcceptFixResponse, error) {
	return p.client.AcceptFix(propagateMetadata(ctx), req)
}

func (p *ArchivistProxy) RejectFix(ctx context.Context, req *flowv1.RejectFixRequest) (*flowv1.RejectFixResponse, error) {
	return p.client.RejectFix(propagateMetadata(ctx), req)
}

func (p *ArchivistProxy) AcceptRefusal(ctx context.Context, req *flowv1.AcceptRefusalRequest) (*flowv1.AcceptRefusalResponse, error) {
	return p.client.AcceptRefusal(propagateMetadata(ctx), req)
}

func (p *ArchivistProxy) RejectRefusal(ctx context.Context, req *flowv1.RejectRefusalRequest) (*flowv1.RejectRefusalResponse, error) {
	return p.client.RejectRefusal(propagateMetadata(ctx), req)
}

func (p *ArchivistProxy) GetFeedbackDepth(ctx context.Context, req *flowv1.GetFeedbackDepthRequest) (*flowv1.GetFeedbackDepthResponse, error) {
	return p.client.GetFeedbackDepth(propagateMetadata(ctx), req)
}

func (p *ArchivistProxy) DeadlockFeedback(ctx context.Context, req *flowv1.DeadlockFeedbackRequest) (*flowv1.DeadlockFeedbackResponse, error) {
