...
// and perform operations (heartbeat, telemetry, etc.) without real backends.
func newSpyGRPCServer() *grpc.Server {
	spy := &noopSpy{}
	srv := grpc.NewServer()
...
// noopSpy embeds the unimplemented servers to satisfy all five interfaces
// with default (no-op) behaviour. It overrides Heartbeat and RecordTelemetry
// to return success instead of Unimplemented.
type noopSpy struct {
