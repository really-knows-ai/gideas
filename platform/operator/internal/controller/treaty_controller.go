...
// +kubebuilder:rbac:groups=flow.foundry.io,resources=treaties,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=flow.foundry.io,resources=treaties/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=flow.foundry.io,resources=treaties/finalizers,verbs=update
