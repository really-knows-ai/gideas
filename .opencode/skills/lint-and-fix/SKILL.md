---
name: lint-and-fix
description: Run markdown linting from tools/lint/, fix issues, and rerun until clean
---
...
It runs the repository linter from `tools/lint/`, fixes reported issues in markdown files, and repeats until `pnpm lint` exits clean.
...
4. Re-run `pnpm lint` in `tools/lint/`.
